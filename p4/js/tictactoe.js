...
$(function () {
    ...
    set = function () {
        ...
        if (win(score[turn])) {
            ...
            let currentGame = document.getElementById("theWinner");
            currentGame.innerHTML = (turn + " wins! \nCongratulations!");
            window.alert(turn + " wins! \nCongratulations!");

        } else if (moves === SIZE * SIZE) {

            let currentGame = document.getElementById("theWinner");
            currentGame.innerHTML = ("Cat\u2019s game!");
     ...
     */
    play = function () {
        var board = $("<table border=1 bordercolor=#bc883d cellspacing=0>"), indicator = 1;
    ...
    // A reset Button
    $("#startover").on("click", startNewGame);
